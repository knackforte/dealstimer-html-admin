                ...
                <div className="content-wrapper">
                    <div className="content-header row">
                        <div className="content-header-left col-md-6 col-xs-12 mb-1">
                            <h2 className="content-header-title">Subscriptions</h2>
                        </div>
                        <div
                            ...
                            <div className="breadcrumb-wrapper col-xs-12">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Subscriptions
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div className="col-md-12">
                            <div className="card">
                                <div className="card-header">
                                    <h4 className="card-title" id="basic-layout-form">Subscriptions</h4>
