...
class Navbar extends Component {
  ...
  render() {
    let toggle = "nav-link nav-menu-main menu-toggle hidden-xs is-active";

    const toggleHandler = (toggler) => {
      if (toggler === "nav-link nav-menu-main menu-toggle hidden-xs is-active") {
        toggle = "nav-link nav-menu-main menu-toggle hidden-xs";
      }
      else {
        toggle = "nav-link nav-menu-main menu-toggle hidden-xs is-active";
      }
    }
    return (
          ...
          <div className="navbar-container content container-fluid">
            <div id="navbar-mobile" className="collapse navbar-toggleable-sm">
              ...
              <ul className="nav navbar-nav float-xs-right">
                <li className="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" className="dropdown-toggle nav-link"><i className="flag-icon flag-icon-gb" /><span className="selected-language">English</span></a>
                  <div aria-labelledby="dropdown-flag" className="dropdown-menu">
                    <a href="#" className="dropdown-item"><i className="flag-icon flag-icon-gb" /> English</a>
                    <a href="#" className="dropdown-item"><i className="flag-icon flag-icon-ua" /> Arabic</a>
                  </div>
                </li>
                <li className="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" className="nav-link nav-link-label"><i className="ficon icon-bell4" /><span className="tag tag-pill tag-default tag-danger tag-default tag-up">5</span></a>
                  <ul className="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    ...
                    <li className="list-group scrollable-container ps-container ps-theme-dark ps-active-y" data-ps-id="cba06368-a5b9-9a3a-4394-276f483e7827"><a href="#" className="list-group-item">
                      <div className="media">
                      ...
                      </div></a><a href="#" className="list-group-item">
                        <div className="media">
                        ...
                        </div></a><div className="ps-scrollbar-x-rail" style={{ left: '0px', bottom: '3px' }}><div className="ps-scrollbar-x" tabIndex={0} style={{ left: '0px', width: '0px' }} /></div><div className="ps-scrollbar-y-rail" style={{ top: '0px', height: '280px', right: '3px' }}><div className="ps-scrollbar-y" tabIndex={0} style={{ top: '0px', height: '207px' }} /></div></li>
                    <li className="dropdown-menu-footer"><a href="#" className="dropdown-item text-muted text-xs-center">Read all notifications</a></li>
                  </ul>
                </li>
                <li className="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" className="nav-link nav-link-label"><i className="ficon icon-mail6" /><span className="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
                  <ul className="dropdown-menu dropdown-menu-media dropdown-menu-right">
                    <li className="dropdown-menu-header">
                    ...
                    <li className="list-group scrollable-container ps-container ps-theme-dark ps-active-y" data-ps-id="f42f5248-81d2-f922-f64f-de65dc0602d0"><a href="#" className="list-group-item">
                      <div className="media">
                        ...
                        </div></a><div className="ps-scrollbar-x-rail" style={{ left: '0px', bottom: '3px' }}><div className="ps-scrollbar-x" tabIndex={0} style={{ left: '0px', width: '0px' }} /></div><div className="ps-scrollbar-y-rail" style={{ top: '0px', height: '280px', right: '3px' }}><div className="ps-scrollbar-y" tabIndex={0} style={{ top: '0px', height: '236px' }} /></div></li>
                    <li className="dropdown-menu-footer"><a href="#" className="dropdown-item text-muted text-xs-center">Read all messages</a></li>
                  </ul>
                </li>
                <li className="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" className="dropdown-toggle nav-link dropdown-user-link"><span className="avatar avatar-online"><img src={avatar_s_one} alt="avatar" /><i /></span><span className="user-name">John Doe</span></a>
                  <div className="dropdown-menu dropdown-menu-right"><a href="#" className="dropdown-item"><i className="icon-head" /> Edit Profile</a><a href="#" className="dropdown-item"><i className="icon-mail6" /> My Inbox</a><a href="#" className="dropdown-item"><i className="icon-clipboard2" /> Task</a><a href="#" className="dropdown-item"><i className="icon-calendar5" /> Calender</a>
                    <div className="dropdown-divider" /><a className="dropdown-item" onClick={this.handleLogout}><i className="icon-power3" /> Logout</a>
                  </div>
                </li>
              </ul>
            </div>
