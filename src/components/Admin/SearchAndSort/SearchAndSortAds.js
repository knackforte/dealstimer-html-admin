...
class SearchAndSortAds extends Component {
    render() {
        return (
                        ...
                        <div
                            ...
                            <div className="breadcrumb-wrapper col-xs-12">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Ads
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div className="col-md-12">
                            <div className="card">
                                <div className="card-header">
                                    <h4 className="card-title" id="basic-layout-form">Ads</h4>
...
export default SearchAndSortAds;
