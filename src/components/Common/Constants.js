...
export const GET_PRODUCTS_API_SCRAPPER_URL = SERVER_ADDRESS + '/api/getProductsFromApiOrScrapper';
export const GET_CATEGORIES = SERVER_ADDRESS + '/api/getCategories';
export const GET_ADMIN_PRODUCTS = SERVER_ADDRESS + '/api/getAdminProducts';
export const GET_ADMIN_PRODUCTS_BY_CATEGORY_ID = SERVER_ADDRESS + '/api/getAdminProductsByCategoryId';
export const IMAGE_PATH = SERVER_ADDRESS + '/images/';


export const SHARAF_DG_CATEGORIES = [
    {
        'value': 'fashion',
        'label': 'Fashion',
        'children': [
